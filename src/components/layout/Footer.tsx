      ...
      <div className="max-w-[1280px] mx-auto px-5 sm:px-[56px] py-16 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[rgba(248,244,233,0.65)] text-sm leading-relaxed mb-5 max-w-[260px]">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-[rgba(248,244,233,0.7)] hover:text-paper text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/courses#commerce-11" className="text-[rgba(248,244,233,0.7)] hover:text-paper text-sm transition-colors">Commerce Class 11th</Link></li>
              <li><Link href="/courses#commerce-12" className="text-[rgba(248,244,233,0.7)] hover:text-paper text-sm transition-colors">Commerce Class 12th</Link></li>
              <li><Link href="/courses#crash-course" className="text-[rgba(248,244,233,0.7)] hover:text-paper text-sm transition-colors">Board Crash Course</Link></li>
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm text-[rgba(248,244,233,0.7)]">
              <p>Score More Academy<br />Katni, Madhya Pradesh<br />India</p>
              <p><span className="text-[rgba(248,244,233,0.4)]">Mon – Sat:</span> 7 AM – 8 PM<br /><span className="text-[rgba(248,244,233,0.4)]">Sunday:</span> 9 AM – 1 PM</p>
        ...
        {/* Bottom */}
        <div className="mt-12 pt-6 border-t border-[rgba(248,244,233,0.12)] flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[rgba(248,244,233,0.4)] text-xs" style={{ fontFamily: 'var(--mono)', letterSpacing: '0.1em' }}>
            © {new Date().getFullYear()} Score More Academy, Katni
          </p>
          <div className="flex items-center gap-4">
            <Link href="/inquiry" className="text-[rgba(248,244,233,0.4)] hover:text-saffron-2 text-xs transition-colors">Admissions</Link>
            <span className="text-[rgba(248,244,233,0.15)]">·</span>
            <Link href="/contact" className="text-[rgba(248,244,233,0.4)] hover:text-saffron-2 text-xs transition-colors">Contact</Link>
          </div>
        </div>
      </div>
    </footer>
